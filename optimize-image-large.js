...
const outputOptimizedPath = path.join(__dirname, 'src', 'assets', 'character-optimized-large.png');

// Optimize to 300px width for larger character
optimizeImage(inputPNGPath, outputOptimizedPath, 300); 