...
const outputOptimizedPath = path.join(__dirname, 'src', 'assets', 'character-optimized.png');

// Optimize to 200px width (adjust as needed)
optimizeImage(inputPNGPath, outputOptimizedPath, 200); 